 ...
 * @author hodangquan
 */
public class EmailSender {private final static String emailGui = "hohoangquan280103@gmail.com";
    private final static String matKhau = "wopnvjfjcyseiheh";
    ...
    public static void main(String[] args) throws MessagingException, InterruptedException {
        ...
        while(true){
            i++;
            EmailSender.guiMail("quanhdph@fpt.edu.vn", "Cảnh Báo" +1 , "Cứ liệu ấy :)))" );
